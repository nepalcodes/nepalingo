    ...
    return (
        <>
            ...
            <div className="p-6 md:p-12 max-w-7xl mx-auto text-white">
                <h1 className="text-4xl font-bold mb-6 text-center text-primary ">Incubate Nepal</h1>
                <p className="mb-8 text-lg leading-relaxed text-center">
                    ...
                    is an 8-week virtual program that connects students
                ...
                <h1 className="text-4xl font-bold mb-6 text-center text-primary">Nepalingo</h1>
                <p className="mb-8 text-lg leading-relaxed text-center">
                    <a
                ...
                <div className="mt-8 text-center">
                    <a
                        href="https://github.com/nepalcodes/nepalingo"
