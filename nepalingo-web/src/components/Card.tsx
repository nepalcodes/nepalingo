...
const Card: React.FC<{
  ...
  return (
    <div>
      <div
        className={`border-2 border-slate-400 relative w-96 h-72 ${
          isFlipped ? "flipped" : ""
        }`}
        onClick={handleFlip}
      ...
      >
        <div
          className="text-4xl font-bold absolute inset-0 text-black flex justify-center items-center backface-hidden"
          style={{
