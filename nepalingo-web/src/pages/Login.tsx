        ...
        <div className="flex max-lg:flex-col max-md:items-center h-[100svh]  text-white">
            ...
            <div className="relative flex flex-1 max-md:flex-none max-md:w-full  justify-center items-center ">
                <form onSubmit={handleSubmit} className="container flex-col w-96  max-lg:w-full  p-2">
                    ...
                    <p
                        className="text-sm text-grayLight mt-2 text-center font-secondary cursor-pointer transition-colors hover:text-gray-300"
                        onClick={() => navigate("/reset-password-email")}
                    >
                        Already have an account? <span className="text-primary underline">Sign Up</span>
                    </p>
                </form>
            </div>
        </div>
